  ...
  head: () => ({
    meta: [
      ...
      { title: "Workplace AI Productivity Assistant" },
      {
        name: "description",
        content:
          "AI assistant for busy teams: generate emails, summarize meeting notes, and plan tasks.",
      },
      { property: "og:title", content: "Workplace AI Productivity Assistant" },
      {
        property: "og:description",
        content:
          "Generate emails, summarize meeting notes, and plan tasks with an editable AI assistant.",
      },
